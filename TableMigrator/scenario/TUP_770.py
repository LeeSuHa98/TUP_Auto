...
for row in commands:
    ...
    print(output)
    if row == 1:
        if tibero.check_tuple_exists(tibero_conn, 'SELECT col1, col3, col4 FROM TRG283075.t283075_2', ['aaaaaaaaaa', 30, 'fourty']):
        ...
        if tibero.check_tuple_exists(tibero_conn, 'SELECT col1 FROM TRG283075.t283075_2', ['aaaaaaaaaa']):
            results.append(f"TC {row} : PASS")
        else:
